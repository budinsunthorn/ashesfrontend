...
import OrgFind from '@/components/etc/orgFind';
interface Store {
    name: string;
...
function page() {
    return (
        ...
        //     <div className='panel max-w-[500px] flex flex-col justify-center items-center'>
        //         <h1>Find Organization</h1>
        //         <div className='flex flex-col justify-start'>
        //             <label htmlFor="email">Input Organization Id or Name:</label>
        //             <input type="text" name='organization' className='form-input' onChange={(e) => setOrganization(e.target.value)}/>
        //         </div>
        //         <button className='btn btn-pramary' onClick={handleFindOrganization}></button>
        //     </div>
            ...
            <div className="relative w-full max-w-[870px] rounded-md bg-[linear-gradient(45deg,#fff9f9_0%,rgba(255,255,255,0)_25%,rgba(255,255,255,0)_75%,_#fff9f9_100%)] p-2 text-center dark:bg-[linear-gradient(52.22deg,#0E1726_0%,rgba(14,23,38,0)_18.66%,rgba(14,23,38,0)_51.04%,rgba(14,23,38,0)_80.07%,#0E1726_100%)]">
                <div className="rounded-md bg-white/60 p-4 backdrop-blur-lg dark:bg-black/50 sm:p-6">
                    <div className="mx-auto mt-5 w-full max-w-[550px] md:mt-16">
                        <div className="mb-12">
                            <h1 className="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl">Find Organization</h1>
                            {/* <p className="text-base font-bold leading-normal text-white-dark">We will be here in a shortwhile.....</p> */}
                        </div>
                        <OrgFind/>
                        <p className="dark:text-white-dark text-dark">© {new Date().getFullYear()}. All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </div>
