...
export default function PrintSetting() {
    ...
    // Windows app setting
    const [enableAutoPrintReceipt, setEnableAutoPrintReceipt] = useState(false);
    const [enableAutoPrintExitLabels, setEnableAutoPrintExitLabels] = useState(false);
    const [appPrintInitialized, setAppPrintInitialized] = useState(false);
    ...
    return (
        <PerfectScrollbar>
            <div className="w-full h-[80wh] overflow-y-auto">
                <h5 className="text-lg font-semibold dark:text-white-dark">Print Setting</h5>
                ...
                <div className="flex flex-col p-4">
                    <div className="text-gray-400 text-lg font-medium mb-4">Windows App Setting</div>
                    ...
                    <div className='flex flex-col my-3 w-full md:w-1/2 ml-5'>
                        <div className='flex justify-between items-center'>
                            <div>Auto-print Receipt On Complete Order</div>
                            <label className="w-12 h-6 relative ml-3 my-auto">
                                <input type="checkbox" className="custom_switch absolute w-full h-full opacity-0 z-10 cursor-pointer peer" id="custom_switch_checkbox1" checked={enableAutoPrintReceipt} onChange={() => setEnableAutoPrintReceipt(!enableAutoPrintReceipt)}/>
                                <span className="bg-[#ebedf2] dark:bg-dark block h-full rounded-full before:absolute before:left-1 before:bg-white dark:before:bg-white-dark dark:peer-checked:before:bg-white before:bottom-1 before:w-4 before:h-4 before:rounded-full peer-checked:before:left-7 peer-checked:bg-primary before:transition-all before:duration-300"></span>
                            </label>
                        </div>
                        <div className='flex justify-between items-center mt-3'>
                            <div>Auto-print Exit Labels On Complete Order</div>
                            <label className="w-12 h-6 relative ml-3 my-auto">
                                <input type="checkbox" className="custom_switch absolute w-full h-full opacity-0 z-10 cursor-pointer peer" id="custom_switch_checkbox1" checked={enableAutoPrintExitLabels} onChange={() => setEnableAutoPrintExitLabels(!enableAutoPrintExitLabels)}/>
                                <span className="bg-[#ebedf2] dark:bg-dark block h-full rounded-full before:absolute before:left-1 before:bg-white dark:before:bg-white-dark dark:peer-checked:before:bg-white before:bottom-1 before:w-4 before:h-4 before:rounded-full peer-checked:before:left-7 peer-checked:bg-primary before:transition-all before:duration-300"></span>
                            </label>
                        </div>
                    </div>
                    <div className="flex justify-end items-center mx-3">
                        <button className="btn btn-primary px-16 mb-2" onClick={() => handleWindowAppSetting()}>
                            Save
                        </button>
                    </div>
                </div>
