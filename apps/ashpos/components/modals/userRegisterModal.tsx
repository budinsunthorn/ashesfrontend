        ...
        await createUserMutation.mutate(
            ...
            },
            {
                ...
                onSuccess(data) {
                    ...
                    successAlert(currentUser.name + ' has been created successfully!');
                },
                onSettled() {
        ...
        await updateUserMutation.mutate(
            ...
            },
            {
                ...
                onSuccess(data) {
                    ...
                    refetch();
                    props.setModalShow(false);
                    successAlert(currentUser.name + ' has been updated successfully!');
                },
                onSettled() {
                    setIsSaveButtonDisabled(false);
                },
                                                    ...
                                                    {({ errors, submitCount, touched, values, handleChange, handleBlur }) => (
                                                        <Form className="space-y-5">
                                                            <div className="panel flex flex-col m-3 gap-3">
                                                                ...
                                                                <div className={`flex flex-col sm:flex-row gap-6 border-b border-white-light pb-4 dark:border-[#1b2e4b] ${submitCount ? (errors.phone ? 'has-error' : '') : ''}`}>
