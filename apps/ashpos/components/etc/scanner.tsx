...
import { intersectionOverUnion } from '@/utils/camera';
import { mrzTemplate } from '../../utils/dcv';
...
const Scanner: React.FC<ScannerProps> = (props:ScannerProps) => {
  ...
  return (
    <div className="scanner-container p-6 bg-black-dark-light dark:bg-white" ref={container}>
