...
const CustomSelect: React.FC<OptionsType> = ({ options, onChange, currentOption, setModalShow, onSearch, disabled = false, isAddCustomerIcon = false, showingSearch = true, showingText = 'Select a customer',  searchDisplayText = 'Search...', autoFocus = false }) => {
