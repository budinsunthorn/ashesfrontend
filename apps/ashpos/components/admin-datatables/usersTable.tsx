...
const UsersTable = () => {
    ...
    const handleNewUser = () => {
        if (
            ...
            currentDispensaryId === '' ||
            currentDispensaryId === 'all' ||
            currentDispensaryId === null
        ) {
            warnAlert('Please select Organization and Dispensary');
            return;
        } else {
            setModalMode('new');
            setModalShow(true);
                ...
                <DataTable
                    ...
                    columns={[
                        ...
                        },
                        {
                            ...
                            render: ({ userType }) => (
                                <span
                                    className={`rounded bg-${userTypeColor(userType)}-100 text-${userTypeColor(userType)}-800 text-xs font-medium me-2 px-2.5 py-0.5 dark:bg-${userTypeColor(userType)}-900 dark:text-${userTypeColor(userType)}-300 ltr:ml-2 rtl:ml-2`}
                                >
                        ...
                        //     title: 'Field-1',
                        //     sortable: true,
                        //     hidden: hideCols.includes('isOrganizationAdmin'),
                        //     render: ({ isOrganizationAdmin }) => (
                        //         <span
                        //             className={`${isOrganizationAdmin ? 'bg-green-100 text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300' : 'bg-gray-100 text-gray-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300'} `}
                        //         >
                        ...
                        //     title: 'Field-2',
                        //     sortable: true,
                        //     hidden: hideCols.includes('isDispensaryAdmin'),
                        //     render: ({ isDispensaryAdmin }) => (
                        //         <span
                        //             className={`${isDispensaryAdmin ? 'bg-green-100 text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300' : 'bg-gray-100 text-gray-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300'} `}
                        //         >
