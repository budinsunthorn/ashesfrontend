...
import { RiStore2Line, RiListSettingsLine, RiGroupLine, RiAdminLine } from 'react-icons/ri';
...
const AdminHeader = () => {
    ...
    const roleColor = `rounded bg-${userTypeColor(userData.userType)}-100 text-${userTypeColor(userData.userType)}-800 text-xs font-medium me-2 px-2.5 py-0.5 dark:bg-${userTypeColor(userData.userType)}-900 dark:text-${userTypeColor(userData.userType)}-300 ltr:ml-2 rtl:ml-2`;
                ...
                <div className="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-black">
                    ...
                    <div className="flex items-center space-x-1.5 ltr:ml-auto rtl:mr-auto rtl:space-x-reverse dark:text-[#d0d2d6] sm:flex-1 ltr:sm:ml-0 sm:rtl:mr-0 lg:space-x-2">
                        ...
                        {/* <div className="dropdown shrink-0">
                            ...
                            >
                                <ul className="grid w-[280px] grid-cols-2 gap-2 !px-2 font-semibold text-dark dark:text-white-dark dark:text-white-dark/90">
                                                ...
                                                {messages.map((message) => {
                                                    return (
                                                        <div key={message.id} className="flex items-center px-5 py-3">
                                                            ...
                                                            <span className="px-3 dark:text-dark">
                                    ...
                                    {notifications.length > 0 ? (
                                        <>
                                            {notifications.map((notification) => {
                                                return (
                                                    <li key={notification.id} className="dark:text-white-dark/90" onClick={(e) => e.stopPropagation()}>
                                                        <div className="group flex items-center px-4 py-2">
                                                            ...
                                                            <div className="flex flex-auto ltr:pl-3 rtl:pr-3">
                                                                <div className="ltr:pr-3 rtl:pl-3">
                                                                    ...
                                                                    ></h6>
                                                                    <span className="block text-xs font-normal dark:text-dark">{notification.time}</span>
                                                                </div>
                                                                <button
                                                                    type="button"
                        ...
                        <div className="dropdown flex shrink-0">
                            ...
                            >
                                <ul className="w-[230px] !py-0 font-semibold text-dark dark:text-white-dark dark:text-white-dark/90">
                                    <li>
                                        <div className=" px-4 py-4">
                                            ...
                                            <div className="truncate ltr:pl-4 rtl:pr-4">
                                                <h4 className="text-base">
                                                    {userData.name}
                                                    <span className={roleColor}>{userTypeTitles(userData.userType)}</span>
                                                </h4>
                    ...
                    <li className="menu nav-item relative">
                        <button type="button" className="nav-link">
                            <div className="flex items-center">
                                <RiAdminLine className="shrink-0 group-hover:!text-primary" />
                            ...
                            <li className="menu nav-item relative">
                                <Link href="/organizations" className="group">
                                    <div className="flex items-center pl-3">
                                        ...
                                        <span className="text-dark ltr:pl-3 rtl:pr-3 dark:text-white-dark dark:group-hover:text-white-dark">{t('organization')}</span>
                                    </div>
                                </Link>
                            </li>
                            <li>
                                <Link href="/dispensaries" className="group">
                                    <div className="flex items-center pl-3">
                                        ...
                                        <span className="text-dark ltr:pl-3 rtl:pr-3 dark:text-white-dark dark:group-hover:text-white-dark">{t('dispensary')}</span>
                                    </div>
                                </Link>
                            </li>
                            <li>
                                <Link href="/users" className="group">
                                    <div className="flex items-center pl-3">
                                        ...
                                        <span className="text-dark ltr:pl-3 rtl:pr-3 dark:text-white-dark dark:group-hover:text-white-dark">{t('user')}</span>
                                    </div>
                                </Link>
                            </li>
                            <li>
                                <Link href="/admins" className="group">
                                    <div className="flex items-center pl-3">
                                        <RiAdminLine className="shrink-0 group-hover:!text-primary" />
                                        <span className="text-dark ltr:pl-3 rtl:pr-3 dark:text-white-dark dark:group-hover:text-white-dark">{t('admin')}</span>
                                    </div>
                                </Link>
                            </li>
                        </ul>
