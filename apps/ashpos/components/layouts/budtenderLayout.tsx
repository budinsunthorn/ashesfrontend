...
import BudtenderSidebar from './factors/BudtenderSidebar';
import BudtenderHeader from './header/BudtenderHeader';

export default function BudtenderLayout({ children }: { children: React.ReactNode }) {
