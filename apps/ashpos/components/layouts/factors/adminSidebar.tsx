...
import { TbDatabaseImport, TbTruckDelivery } from 'react-icons/tb';
                    ...
                    <div className="h-full bg-white dark:bg-black">
                        <div className="flex items-center justify-between px-4 py-3">
                            <Link href="/" className="main-logo flex shrink-0 items-center">
                                ...
                                {themeConfig.menu == "collapsible-vertical" && logoShow ? <img className="ml-[5px] w-8 flex-none" src="/assets/images/logo.png" alt="logo" />
                                :
                        ...
                        <PerfectScrollbar className="relative h-[calc(100vh-80px)]">
                            <ul className="relative space-y-0.5 p-4 py-0 font-semibold">
                                <h2 className="-mx-4 mb-1 flex items-center bg-white-light/30 px-7 py-3 font-extrabold uppercase dark:bg-dark dark:bg-opacity-[0.08]">
                                    <RiAdminFill className="shrink-0 group-hover:!text-primary" />
                                    <span className="ml-1">{t('administrator')}</span>
                                </h2>
                                <li className="menu nav-item ml-5">
                                    <Link href="/organizations" className="group">
                                        <div className="flex items-center">
                                            ...
                                            <span className="text-dark dark:text-white-dark ltr:pl-3 rtl:pr-3 dark:group-hover:text-white-dark">{t('organization')}</span>
                                        </div>
                                    </Link>
                                </li>
                                <li className="menu nav-item ml-5">
                                    <Link href="/dispensaries" className="group">
                                        <div className="flex items-center">
                                            ...
                                            <span className="text-dark dark:text-white-dark ltr:pl-3 rtl:pr-3 dark:group-hover:text-white-dark">{t('dispensary')}</span>
                                        </div>
                                    </Link>
                                </li>
                                <li className="menu nav-item ml-5">
                                    <Link href="/users" className="group">
                                        <div className="flex items-center">
                                            ...
                                            <span className="text-dark dark:text-white-dark ltr:pl-3 rtl:pr-3 dark:group-hover:text-white-dark">{t('user')}</span>
                                        </div>
                                    </Link>
                                </li>
                                <li className="menu nav-item ml-5">
                                    <Link href="/admins" className="group">
                                        <div className="flex items-center">
                                            ...
                                            <span className="text-dark dark:text-white-dark ltr:pl-3 rtl:pr-3 dark:group-hover:text-white-dark">{t('admin')}</span>
                                        </div>
                                    </Link>
                                </li>
                                <li className="menu nav-item ml-5">
                                    <Link href="/import_Metrc" className="group">
                                        <div className="flex items-center">
                                            <TbDatabaseImport className="shrink-0 group-hover:!text-primary" />
                                            <span className="text-dark dark:text-white-dark ltr:pl-3 rtl:pr-3 dark:group-hover:text-white-dark">{t('Import Metrc')}</span>
                                        </div>
                                    </Link>
                                </li>
                            </ul>
